...
offckb deploy --network devnet --target <contract-binary-path> --output /Users/telkom/Development/github/web3/nckb/contracts/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /Users/telkom/Development/github/web3/nckb/contracts/deployment
```
